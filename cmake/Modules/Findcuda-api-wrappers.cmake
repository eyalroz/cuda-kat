...
find_path(
	...
	HINTS
		...
		$ENV{HOME}/opt 
		${CMAKE_PREFIX_PATH}/cuda-api-wrappers
...
find_package_handle_standard_args(cuda-api-wrappers
	FOUND_VAR     cuda-api-wrappers_FOUND
...
add_library(cuda-api-wrappers UNKNOWN IMPORTED)
set_target_properties(cuda-api-wrappers PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${CUDA_API_WRAPPERS_INCLUDE_DIR}")
