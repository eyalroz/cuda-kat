 ...
 * @file span.hpp
 *
 * @brief A non-owning reference-type for a contiguous sequence of values in
 * memory, having all trappings of a standard-library container
 *
 * @note Significant changes:
 *   1. Not using a byte type
 *   2. Not using Expects()
 *   3. No GSL_SUPPRESS
 *   4. Copied some stuff from gsl_util to avoid having all of it
 *
 * @todo 
 *
 *   1. Add kat::array equivalents for std::array-related code (traits, methods etc.)
 *   2. Add __host__ KAT_DEV markers where relevant
 *   3. Write a __host__ KAT_DEV -capable version of std::lexicographic compare
 */

///////////////////////////////////////////////////////////////////////////////
//
// Original code Copyright (c) 2015 Microsoft Corporation. All rights reserved.
// Modifications Copyright (c) 2019 Eyal Rozenberg, under the general license
// terms for cuda-kat.
//
//
...
// #include <kat/containers/array>     // for kat::array
